...
export const RecoveryEmail = ({ siteName, confirmationUrl }: RecoveryEmailProps) => (
  <Html lang="tr" dir="ltr">
    <Head />
    <Preview>Şifre sıfırlama talebi — {siteName}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          {siteName} hesabınız için bir şifre sıfırlama talebi aldık.
        ...
        <Hr style={hr} />
        <Text style={footer}>
          Bu talebi siz yapmadıysanız hiçbir işlem yapmanıza gerek yok —
          şifreniz değişmeyecektir. Hesabınızın güvenliğinden endişe
          duyuyorsanız lütfen bizimle iletişime geçin.
        </Text>

...
const STATIC_ROUTES = [
  ...
  { path: "/haftanin-firsatlari", changefreq: "weekly", priority: "0.85" },
  { path: "/ilan-ver", changefreq: "monthly", priority: "0.8" },
  { path: "/rehber/evcil-hayvan-bakimi-fiyatlari", changefreq: "monthly", priority: "0.75" },
  { path: "/rehber/bakici-ucretleri", changefreq: "monthly", priority: "0.8" },
  { path: "/hakkimizda", changefreq: "monthly", priority: "0.7" },
  { path: "/iletisim", changefreq: "monthly", priority: "0.6" },
  { path: "/destek", changefreq: "monthly", priority: "0.6" },
  ...
  server: {
    handlers: {
      GET: async () => {
        ...
        let listings: Array<{ id: string; slug: string | null; title: string | null; updated_at: string | null }> = [];
        try {
